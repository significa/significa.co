...
<MediaBlock
  src="/blog/can-creativity-be-tamed/david-carson-cluttered-desktop.jpg"
  alt="David Carson's famously cluttered desktop"
  caption="David Carson's famously cluttered desktop"
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/can-creativity-be-tamed/designers-sketching-at-significa.jpg"
  alt="Designers sketching at Significa"
  caption="Designers often structure their thoughts with sketches"
  width={1200}
  height={630}
  layout="full"
/>
...
<Callout
  ...
  href="https://rework.withgoogle.com/guides/understanding-team-effectiveness/steps/introduction/"
  cta="Discover now"
>
...
<MediaBlock
  src="/blog/can-creativity-be-tamed/whiteboard-challenge-session.jpg"
  alt="Significa team during a whiteboard challenge session"
  caption="Whiteboard challenges offer a safe space to explore ideas freely"
  width={1200}
  height={630}
  layout="full"
/>
...
<Callout title="Curious?" href="/blog/interning-at-a-digital-product-agency" cta="Read it">
  Get to how we keep the design vibes flowing at Significa — we've got an article where we spill the beans on our design culture
  magic.
</Callout>
