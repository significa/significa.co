...
<MediaBlock src="/blog/dark-ui-why-when-where/dark-side-placeholder.jpg" alt="Dark UI sports project example" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/dark-ui-examples-placeholder.jpg" alt="Dark UI design examples" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/streaming-gaming-placeholder.jpg" alt="Dark UI in streaming and gaming products" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/code-editor-placeholder.jpg" alt="Dark UI in a code editor environment" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/contrast-examples-placeholder.jpg" alt="Contrast comparison on dark backgrounds" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/text-heavy-placeholder.jpg" alt="Text-heavy content benefits from light backgrounds" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/font-weights-placeholder.jpg" alt="Font weight adjustments for dark backgrounds" width={1200} height={630}
  layout="full"
/>
...
<MediaBlock src="/blog/dark-ui-why-when-where/spacing-example-placeholder.jpg" alt="Generous spacing on dark UI layouts" width={1200} height={630}
  layout="full"
/>
