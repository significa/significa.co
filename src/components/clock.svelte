...
<div class="flex justify-center">
  <div class="relative">
    <div class="absolute bottom-20 left-1/2 -translate-x-1/2 text-center text-sm">
    ...
    <svg width="564" height="564" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
      ...
      <g transform="rotate(-90 282 282)">
        <circle
          ...
          cy="282"
          r="274"
          stroke="hsl(var(--color-foreground-tertiary))"
          stroke-width="16"
