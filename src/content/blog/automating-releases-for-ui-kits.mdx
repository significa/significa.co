...
<MediaBlock
  src="/blog/automating-releases-for-ui-kits/commitizen-cli-placeholder.jpg"
  alt="Commitizen CLI prompt showing commit type selection"
  width={1200}
  height={630}
  caption="The commitizen CLI guides you through structuring your commit message."
  layout="full"
/>
...
<MediaBlock
  src="/blog/automating-releases-for-ui-kits/commitlint-validation-placeholder.jpg"
  alt="Commitlint validation output in the terminal"
  width={1200}
  height={630}
  caption="Commitlint catches invalid commit messages before they go through."
  layout="full"
/>
...
<MediaBlock
  src="/blog/automating-releases-for-ui-kits/commit-analyzer-placeholder.jpg"
  alt="Commit analyzer output showing release type determination"
  width={1200}
  height={630}
  caption="The commit analyzer determines whether a release is a patch, minor, or major bump."
  layout="full"
/>
...
<MediaBlock
  src="/blog/automating-releases-for-ui-kits/release-notes-placeholder.jpg"
  alt="Generated release notes changelog example"
  width={1200}
  height={630}
  caption="Auto-generated release notes based on your commit history."
  layout="full"
/>
...
<MediaBlock
  src="/blog/automating-releases-for-ui-kits/conclusion-placeholder.jpg"
  alt="Overview of the full automated release pipeline"
  width={1200}
  height={630}
  caption="The full pipeline: conventional commits → commitlint → semantic-release → changelog."
  layout="full"
/>
