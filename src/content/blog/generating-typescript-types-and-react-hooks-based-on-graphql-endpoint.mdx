...
<MediaBlock
  src="/blog/generating-typescript-types-and-react-hooks-based-on-graphql-endpoint/editor-autocomplete-placeholder.jpg"
  alt="Editor autocomplete with generated TypeScript types"
  width={1200}
  height={630}
  caption="Generated types give your editor meaningful autocomplete and error checking."
  layout="full"
/>
