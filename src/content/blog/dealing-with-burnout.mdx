...
<MediaBlock
  src="/blog/dealing-with-burnout/chinese-youth-lying-flat-protest.jpg"
  alt="Chinese youth trend of lying flat or dressing down as protest against hustle culture"
  width={1200}
  height={630}
  caption="Trends like Chinese youth pretending to be birds protest against extreme work hours and hyper-productivity."
  layout="full"
/>
...
<MediaBlock
  src="/blog/dealing-with-burnout/four-types-of-burnout.jpg"
  alt="Illustration of the four types of burnout"
  width={1200}
  height={630}
  caption="There are four different kinds of burnout — and even a term for when you just feel 'blah'."
  layout="full"
/>
...
<MediaBlock
  src="/blog/dealing-with-burnout/languishing-book-cover-corey-keyes.jpg"
  alt="Book cover of Languishing by Corey Keyes"
  width={1200}
  height={630}
  caption="Languishing: How to Feel Alive Again in a World That Tears Us Down, by Corey Keyes."
  layout="full"
/>
...
<Callout
  ...
  href="https://www.nytimes.com/interactive/2021/well/burnout-quiz.html"
  cta="Take the NYT Quiz!"
>
