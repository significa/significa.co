...
altText: mishmash store on mobile and desktop showing a product card with Shop now button
...
<MediaBlock
  ...
  alt="Redesign outcome metrics including 148% sales growth, 34% conversion rate, and 4-month ROI"
  layout="wide"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Project goals sticky-note board split into Design, Commercial, and Operational improvement areas"
  layout="wide"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Mishmash UI concept animation translating product colours and shapes into the website design"
  layout="wide"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Mishmash UI component library showing buttons, product cards, sorting controls, and cart upsell"
  layout="wide"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Block-based page builder demo showing modular content sections adapting to different layouts"
  layout="wide"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Simplified purchase flow walkthrough showing streamlined add-to-cart and checkout steps"
  layout="medium"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Redesigned product page with specs, variants, and add-to-cart moved above the fold"
  layout="medium"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Navigation menu cross-sell feature showing Bestsellers and You may also like recommendations"
  layout="medium"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Swipeable product card thumbnails letting customers browse images without leaving the listing"
  layout="medium"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="You may also like product grid with four stationery cards showing sale and bestseller badges"
  layout="medium"
  width={1920}
  height={1080}
/>
...
<MediaBlock
  ...
  alt="Cart upsell panel showing frequently bought together items and free shipping threshold nudge"
  layout="medium"
  width={1920}
  height={1080}
/>
