...
[React](https://react.dev/) (and other tools like [Svelte](https://svelte.dev/)) help developers build interactive stuff. Not just pretty buttons — buttons that _do things_ without reloading the whole page.
