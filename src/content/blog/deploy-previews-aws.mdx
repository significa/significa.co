...
<MediaImage src="/blog/deploy-previews-aws/deploy-preview-example-placeholder.jpg" alt="Deploy Preview example showing a PR with a commit status linking to the preview URL" width={1200} height={630} caption="A commit status on the Pull Request links directly to the deploy preview URL." />
...
<MediaImage src="/blog/deploy-previews-aws/github-status-placeholder.jpg" alt="GitHub commit status showing the deploy preview URL" width={1200} height={630} caption="Using GitHub Status keeps your PR clean while still surfacing the deploy preview URL." />
