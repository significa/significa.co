...
<MediaBlock
  src="/blog/using-websockets-with-cookie-based-authentication/cookie-auth-flow-placeholder.jpg"
  alt="Cookie-based authentication flow"
  width={1200}
  height={630}
  caption="Cookie-based authentication flow."
  layout="full"
/>
...
<MediaBlock
  src="/blog/using-websockets-with-cookie-based-authentication/websocket-lifetime-placeholder.jpg"
  alt="Lifetime of a WebSocket connection"
  width={1200}
  height={630}
  caption="Lifetime of a WebSocket connection."
  layout="full"
/>
