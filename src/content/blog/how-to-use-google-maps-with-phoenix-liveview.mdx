...
<MediaBlock
  src="/blog/how-to-use-google-maps-with-phoenix-liveview/google-map-liveview-placeholder.jpg"
  alt="Google Map rendered in a LiveView page."
  width={1200}
  height={630}
  caption="Google Map rendered in a LiveView page."
  layout="full"
/>
...
<MediaBlock
  src="/blog/how-to-use-google-maps-with-phoenix-liveview/live-map-markers-placeholder.jpg"
  alt="Adding server side generated markers to the live map."
  width={1200}
  height={630}
  caption="Adding server side generated markers to the live map."
  layout="full"
/>
...
```html
<section class="row" phx-update="ignore" phx-hook="MapSightingsHandler"></section>
```
