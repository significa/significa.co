...
As Jessica reflected on Step 07: _Kill Them With Kindness_, referring to flagrant sexism and misogyny in the creative industry (particularly from women towards other women), considering the data below, and concluding with the motto "promote what you love instead of bashing what you hate", she decided to do something about it. Tcharan! [Ladies, Wine and Design](https://ladieswinedesign.com/) was born.

<MediaBlock
  src="/blog/walk-the-walk-talk-the-talk/sexism-data.jpg"
  alt="Data on sexism and misogyny in the creative industry"
  width={1200}
  height={800}
  layout="full"
/>
...
With a team of such diverse backgrounds, from architecture degrees to masters in community work or curating art, the topic of this edition of Ladies Wine and Design couldn't resonate more with us! _Paths in Design_ (originally "Percursos no Design") was all about sharing experiences about different career paths and how intricate these can be.
...
<MediaBlock
  src="/blog/walk-the-walk-talk-the-talk/event-photos.jpg"
  alt="Ladies, Wine and Design event at Significa's Porto office"
  width={1200}
  height={800}
  layout="full"
/>
