...
<MediaBlock src="/blog/dealing-with-burnout/four-types-of-burnout.jpg" alt="Illustration of the four types of burnout" width={1200} height={630} caption="There are four different kinds of burnout — and even a term for when you just feel 'blah'."
  layout="full"
/>
...
<MediaBlock src="/blog/dealing-with-burnout/languishing-book-cover-corey-keyes.jpg" alt="Book cover of Languishing by Corey Keyes" width={1200} height={630} caption="Languishing: How to Feel Alive Again in a World That Tears Us Down, by Corey Keyes."
  layout="full"
/>
