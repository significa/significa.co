...
<MediaBlock
  src="/blog/designing-for-colourblind-people/symbols-dont-do.jpg"
  alt="Pagination example showing Don't (colour only) vs Do (colour + shape)"
  width={1200}
  height={630}
  caption="Don't rely on colour alone — combine it with symbols or shapes to convey state."
  layout="full"
/>
...
<MediaBlock
  src="/blog/designing-for-colourblind-people/contrast-examples.jpg"
  alt="Examples of sufficient and insufficient colour contrast ratios"
  width={1200}
  height={630}
  caption="High-contrast combinations like black and white or blue and yellow improve legibility for all users."
  layout="full"
/>
...
<MediaBlock
  src="/blog/designing-for-colourblind-people/infographic-patterns.jpg"
  alt="Infographic chart using both colours and patterns for differentiation"
  width={1200}
  height={630}
  caption="Using patterns alongside colours makes charts readable for people with colour blindness."
  layout="full"
/>
...
<MediaBlock
  src="/blog/designing-for-colourblind-people/line-chart-patterns.jpg"
  alt="Line chart using different dash patterns in addition to colours"
  width={1200}
  height={630}
  caption="Different line patterns ensure charts remain legible without depending on colour alone."
  layout="full"
/>
...
<MediaBlock
  src="/blog/designing-for-colourblind-people/focus-state-example.jpg"
  alt="Example of a clear focus outline on an interactive element"
  width={1200}
  height={630}
  caption="A bold outline around focused elements ensures keyboard navigators always know where they are."
  layout="full"
/>
...
<MediaBlock
  src="/blog/designing-for-colourblind-people/coloradd-symbols.jpg"
  alt="ColorADD symbol system representing different colours"
  width={1200}
  height={630}
  caption="The ColorADD symbol system allows colour-blind individuals to identify colours through geometric shapes."
  layout="full"
/>
