    ...
    <>
      ...
      <ul>
        {Array.from({ length: pageContext.numPages }).map((item, i) => {
          ...
          return <li>{pageContext.currentPage === index ? <span>{index}</span> : <a href={link}>{index}</a>}</li>;
        })}
      </ul>
    </>
  );
    ...
    <>
      ...
      <ul>
        {Array.from({ length: pageContext.numPages }).map((item, i) => {
          ...
          const link = index === 1 ? `/blog/category/${category}` : `/blog/category/${category}/page/${index}`;
