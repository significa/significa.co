...
<MediaBlock
  src="/blog/maximising-conversions-using-block-based-design/mishmash-design-system.jpg"
  alt="Design system for e-commerce store mishmash"
  caption="Design system for e-commerce store mishmash."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/maximising-conversions-using-block-based-design/mishmash-storyblok-visual-editor.jpg"
  alt="Storyblok's visual editor on mishmash e-commerce shop"
  caption="Storyblok's visual editor on mishmash e-commerce shop."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/maximising-conversions-using-block-based-design/hey-harper-block-mix-and-match.jpg"
  alt="Blocks allow Hey Harper to mix and match blocks as they see fit"
  caption="Blocks allow Hey Harper to mix and match blocks as they see fit."
  width={1200}
  height={630}
  layout="full"
/>
...
<Callout title="Trivia Time" href="https://en.wikipedia.org/wiki/ARPANET" cta="Learn more">
  Did you know the first instance of e-commerce was a pot deal? In 1971, students at Stanford University used ARPANET (the
  precursor to the internet) to trade marijuana. However, this early venture was short-lived, as the university quickly shut
  down the operation.
</Callout>
...
<MediaBlock
  src="/blog/maximising-conversions-using-block-based-design/mishmash-roi-4-months.jpg"
  alt="mishmash had a return on investment in just 4 months"
  caption="mishmash had a return on investment in just 4 months."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/maximising-conversions-using-block-based-design/hey-harper-sales-increase-59-percent.jpg"
  alt="In 6 months, Hey Harper increased their sales by 59%"
  caption="In 6 months, Hey Harper increased their sales by 59%."
  width={1200}
  height={630}
  layout="full"
/>
