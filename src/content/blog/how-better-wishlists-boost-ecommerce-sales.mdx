...
<MediaBlock
  src="/blog/how-better-wishlists-boost-ecommerce-sales/hey-harper-wishlist-non-registered-users.jpg"
  alt="Hey Harper wishlist feature for non-registered users"
  caption="Hey Harper's wishlist is available to all users, even without an account."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/how-better-wishlists-boost-ecommerce-sales/hey-harper-wishlist-easy-interaction.jpg"
  alt="Easy wishlist interaction on Hey Harper"
  caption="Adding items to the wishlist is seamless — users can continue browsing without interruption."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/how-better-wishlists-boost-ecommerce-sales/hey-harper-wishlist-out-of-stock-notification.jpg"
  alt="Out of stock notification request on Hey Harper"
  caption="Customers can request a restock notification even without an account."
  width={1200}
  height={630}
  layout="full"
/>
...
<MediaBlock
  src="/blog/how-better-wishlists-boost-ecommerce-sales/hey-harper-wishlist-mobile-desktop.jpg"
  alt="Wishlist experience on mobile and desktop"
  caption="The wishlist feature optimised across mobile and desktop."
  width={1200}
  height={630}
  layout="full"
/>
